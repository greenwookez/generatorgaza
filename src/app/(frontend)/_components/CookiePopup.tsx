...
export const CookiePopup = () => {
  ...
  return (
    <div className="z-50 fixed bottom-4 left-3 max-sm:right-3 max-sm:flex-col max-sm:items-start sm:w-[480px] bg-background py-4 px-5 border border-border2 shadow-[0px_5px_20px_0px_rgba(0,31,84,0.08)] rounded-[16px] flex gap-3 items-center text-muted-foreground text-[0.75rem] leading-[1.125rem] max-sm:animate-cookie-appear-bottom sm:animate-cookie-appear-left">
      <span>
