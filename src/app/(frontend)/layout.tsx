...
// Перед релизом:
// [ ]: Формы обратной связи: UX, валидация на фронте и бэке, защита от спама, явный чекбокс на согласие с политикой обработки персональных данных
// [ ]: Главная: фото, тексты, видео на Rutube или self-hosted
// [ ]: О предприятии: фото, тексты и адаптация под мобильные
// [ ]: Сертификаты: фото, тексты и адаптация под мобильные
...
// [ ]: Что-то с кэшем, на статиках в хэдере в каталоге доступны не все пункты меню
// -----------------------------------------------------
