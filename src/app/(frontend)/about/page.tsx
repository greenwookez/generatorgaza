      ...
      <div className="flex flex-col gap-y-7">
        ...
        <div className="flex gap-x-10">
          <p className="text-[1.25rem] leading-[160%]">
            ...
            Предприятие имеет свои филиалы в городах Москва, Подольск, Екатеринбург. Осуществляет
            ремонт и техническое освидетельствование баллонов. В магазинах завода продается широкий
            ассортимент электро-газосварочного оборудования и расходных материалов.
          </p>
          <Image
            alt={'Скания'}
